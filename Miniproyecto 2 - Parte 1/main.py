...
def MyCCorrelation_function(image, kernel, boundary_condition):
...
plt.subplot(132)
plt.imshow(MyCCorrelation_function(image1, Kernel3a, 'fill'), cmap="gray")
...
plt.show()
print(np.max(MyCCorrelation_function(image2, Kernel3a, 'fill')))
print(np.max(MyCCorrelation_function(image2, Kernel3b, 'fill')))
image1_vec=np.hstack(image1)
image1_2d_vec=np.hstack(ss.correlate2d(image1, Kernel3a,boundary='fill'))
image1_myc_vec=np.hstack(MyCCorrelation_function(image1, Kernel3a, 'fill'))
...
plt.subplot(132)
plt.imshow(MyCCorrelation_function(image2, Kernel3a, 'fill'), cmap="gray")
plt.title('My Cross-Correlación Kernel 3a', fontsize=18)
plt.axis('off')

plt.subplot(133)
plt.imshow(MyCCorrelation_function(image2, Kernel3b, 'fill'), cmap="gray")
...
plt.subplot(133)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(5, sigma=1), 'fill'), cmap="gray")
...
plt.figure(figsize = (20,10))
plt.subplot(131)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(5, sigma=3), 'fill'), cmap="gray")
plt.title('My Cross-Correlación sigma=3', fontsize=18)
plt.axis('off')

plt.subplot(132)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(5, sigma=6), 'fill'), cmap="gray")
plt.title('My Cross-Correlación sigma=6', fontsize=18)
plt.axis('off')

plt.subplot(133)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(5, sigma=9), 'fill'), cmap="gray")
...
plt.figure(figsize = (20,10))
plt.subplot(131)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(3, sigma=1), 'fill'), cmap="gray")
...
plt.subplot(133)
plt.imshow(MyCCorrelation_function(image2, gaussian_kernel(7, sigma=1), 'fill'), cmap="gray")
...
plt.figure(figsize = (20,10))
plt.subplot(122)
plt.imshow(MyCCorrelation_function(image1, Kernel3c, 'fill'), cmap="gray")
plt.title('My Cross-Correlación Kenel3c', fontsize=30)
plt.axis('off')

plt.subplot(121)
plt.imshow(MyCCorrelation_function(image1, Kernel3d, 'fill'), cmap="gray")
...
plt.figure(figsize = (20,10))
plt.subplot(122)
plt.imshow(MyCCorrelation_function(MyCCorrelation_function(image1, Kernel3c, 'fill'), Kernel3d, 'fill'), cmap="gray")
plt.title('My Cross-Correlación Kenel3c&3d', fontsize=30)
plt.axis('off')
gdx=MyCCorrelation_function(image1, Kernel3c, 'fill')
gdy=MyCCorrelation_function(image1, Kernel3d, 'fill')
