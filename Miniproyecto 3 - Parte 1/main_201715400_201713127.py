...
imagen_prueba = os.path.join('Miniproyecto 3 - Parte 1','data_mp3','star_binary.png')
lista=glob.glob(os.path.join('Miniproyecto 3 - Parte 1','data_mp3','blood_cell_dataset', 'noisy_data', '*.png'))
gt=glob.glob(os.path.join('Miniproyecto 3 - Parte 1','data_mp3','blood_cell_dataset', 'groundtruth', '*.png'))
lista_b=[]
lista_i = []
